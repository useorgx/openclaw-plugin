          ...
          options: [
            {
              id: "retry_now",
              label: "Retry now",
              description: "Retry this slice immediately with the latest context.",
              consequences: "Autopilot restarts the same slice run.",
            ...
            {
              id: "inspect_logs",
              label: "Inspect logs first",
              description: "Pause this lane and open output/log evidence.",
              consequences: "Keeps this lane blocked until an operator follows up.",
            ...
            },
            {
              ...
              description: "Stop the run and create a handoff note.",
              consequences: "Autopilot run stops and requires manual restart.",
              implied_status: "declined",
              action_type: "pause",
              requires_note: true,
            },
          ...
          options: [
            {
              ...
              description: "Accept the proposed slice changes.",
              consequences: "Autopilot continues to the next step in this workstream.",
              implied_status: "approved",
              action_type: "approve",
              requires_note: false,
            },
            {
              ...
              description: "Reject and ask for revision before resume.",
              consequences: "Agent remains blocked until revised direction is provided.",
              implied_status: "declined",
              action_type: "reject",
              requires_note: true,
            },
            {
              id: "skip_workstream",
              label: "Skip this workstream",
              description: "Defer this lane and keep other lanes running.",
              consequences: "This lane moves to deferred while other work continues.",
              implied_status: "declined",
              action_type: "defer",
              requires_note: true,
            },
