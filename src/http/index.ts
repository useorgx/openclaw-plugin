...
const CONTENT_SECURITY_POLICY = [
  ...
  "media-src 'self'",
  "connect-src 'self' https://*.useorgx.com https://*.openclaw.ai https://api.openai.com https://*.openai.com https://o4507108730077184.ingest.us.sentry.io http://127.0.0.1:* http://localhost:*",
].join("; ");
